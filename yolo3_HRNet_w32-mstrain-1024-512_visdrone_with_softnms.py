...
data_root = '/home/ubuntu/data/visdrone/'
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100,
        min_bbox_size=0,
        nms=dict(iou_threshold=0.45, type='soft_nms'),
        nms_pre=1000,
        score_thr=0.05),
    train_cfg=dict(
        assigner=dict(
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='VisDrone2019-DET-val/annotations/instances_val2017.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file=
    '/home/ubuntu/data/visdrone/VisDrone2019-DET-val/annotations/instances_val2017.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
train_dataloader = dict(
    ...
    batch_size=1,
    dataset=dict(
        ann_file='VisDrone2019-DET-train/annotations/instances_train2017.json',
        backend_args=None,
...
work_dir = './work_dirs/yolo3_HRNet_w32-mstrain-1024-512_visdrone_with_softnms'
